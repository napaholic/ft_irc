...
: __port(port), __password(password) {
    ...
    __cmd_list.insert(std::pair<unsigned long>(djb2("NICK"), &Server::NICK));
    __cmd_list.insert(std::pair<unsigned long>(djb2("QUIT"), &Server::QUIT));
    __cmd_list.insert(std::pair<unsigned long>(djb2("JOIN"), &Server::JOIN));
    __cmd_list.insert(std::pair<unsigned long>(djb2("USER"), &Server::USER));
    __cmd_list.insert(std::pair<unsigned long>(djb2("TOPIC"), &Server::TOPIC));
    __cmd_list.insert(std::pair<unsigned long>(djb2("INVITE"), &Server::INVITE));
    __cmd_list.insert(std::pair<unsigned long>(djb2("KICK"), &Server::KICK));
    __cmd_list.insert(std::pair<unsigned long>(djb2("MODE"), &Server::MODE));
    __cmd_list.insert(std::pair<unsigned long>(djb2("PRIVMSG"), &Server::PRIVMSG));
    __cmd_list.insert(std::pair<unsigned long>(djb2("NOTICE"), &Server::NOTICE));
